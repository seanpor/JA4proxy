...
| `CHANGELOG.md` | Prepend a new entry at the top only. |
...
| `docs/phases/TODO.md` | READ ONLY. Regenerated by `make sync`. |
...
- `CHANGELOG.md`: one entry per phase in the standard format.
