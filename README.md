...
![Go Tests](https://github.com/anomalyco/ja4proxy/actions/workflows/ci.yml/badge.svg?label=go%20tests)
[![Docker Ready](https://img.shields.io/badge/docker-compose-ready-2496ED.svg?logo=docker)](docker-compose.poc.yml)
[![Semgrep](https://github.com/anomalyco/ja4proxy/actions/workflows/ci.yml/badge.svg?label=semgrep)](https://github.com/anomalyco/ja4proxy/actions/workflows/ci.yml)
[![Secrets Scan](https://github.com/anomalyco/ja4proxy/actions/workflows/ci.yml/badge.svg?label=secrets)](https://github.com/anomalyco/ja4proxy/actions/workflows/ci.yml)
