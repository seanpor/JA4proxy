...
demo_architecture() {
    ...
    command_demo "docker compose -f deploy/docker/docker-compose.poc.yml ps"
...
conclusion() {
    ...
    echo "   docker compose -f deploy/docker/docker-compose.poc.yml logs -f"
    echo ""
    
    echo "5. Stop the POC:"
    echo "   docker compose -f deploy/docker/docker-compose.poc.yml down"
    echo ""
