...
class TestMonitoringIntegration:
    ...
    async def test_full_monitoring_cycle(self):
        ...
        monitoring.drift_detector._get_historical_baseline = (
            mock_get_historical_baseline
        )
        monitoring.distribution_analyzer._get_current_baseline = (
            mock_get_current_baseline
        )
        monitoring.distribution_analyzer._get_historical_baseline = (
            mock_get_historical_baseline
        )
    ...
    async def test_metrics_update(self):
        ...
        shadow_stats = {"median": 8.0, "mean": 7.5, "stddev": 2.0, "count": 50}
...
class TestMonitoringMissingCoverage:
    ...
    async def test_get_drift_history_delegates(self):
        ...
        config = {}
        monitoring = MonitoringSystem(mock_redis, config)
        monitoring.drift_detector.get_drift_history = AM(
            return_value=[{"hour": "2024-01-01-00"}]
        )
    ...
    async def test_get_shift_history_delegates(self):
        ...
        monitoring.distribution_analyzer.get_shift_history = AM(
            return_value=[{"hour": "x"}]
        )
    ...
    async def test_get_calibration_history_delegates(self):
        ...
        mock_redis = AsyncMock()
        monitoring = MonitoringSystem(mock_redis, {})
        monitoring.shadow_scoring.get_calibration_history = AM(
            return_value=[{"h": "y"}]
        )
    ...
    async def test_check_api_authentication_delegates(self):
        ...
        mock_redis = AsyncMock()
        monitoring = MonitoringSystem(mock_redis, {})
        monitoring.security_hardening.authenticate_api_key = AM(
    ...
    async def test_validate_jwt_token_delegates(self):
        ...
        mock_redis = AsyncMock()
        monitoring = MonitoringSystem(mock_redis, {})
        monitoring.security_hardening.validate_jwt_token = AM(
    ...
    async def test_get_security_audit_logs_delegates(self):
        ...
        mock_redis = AsyncMock()
        monitoring = MonitoringSystem(mock_redis, {})
        monitoring.security_hardening.get_security_audit_logs = AM(
            return_value=[{"ts": 1}]
        )
    ...
    async def test_get_security_metrics_delegates(self):
        ...
        mock_redis = AsyncMock()
        monitoring = MonitoringSystem(mock_redis, {})
        monitoring.security_hardening.get_security_metrics = AM(
