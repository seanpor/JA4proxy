...
def test_nondestructive_restore_preserves_existing_keys():
    ...
    try:
        ...
        mock_redis.keys.return_value = [b"existing_key", b"config:dial", b"ban:192.168.1.1"]
        mock_redis.get.side_effect = lambda key: b"existing_value" if key == b"existing_key" else None
