    ...
    def test_init_with_custom_config(self):
        ...
        config = {
            'sni_analyzer': {
                ...
                'dga_detection': {'enabled': False, 'entropy_threshold': 4.0, 'score_cap': 30},
...
class TestSNIAnalyzerAnalyze:
    ...
    def test_dga_score_capping(self):
        ...
        config = {
            'sni_analyzer': {
                'dga_detection': {
                    'score_cap': 30  # Lower than default 40
                }
            }
        }
        analyzer = SNIAnalyzer(config)
...
class TestEdgeCases:
    ...
    def test_sni_case_insensitive(self):
        ...
        config = {
            'sni_analyzer': {
                'expected_hostnames': ['example.com']
            }
        }
        analyzer = SNIAnalyzer(config)
