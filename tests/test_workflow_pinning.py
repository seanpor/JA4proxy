...
KNOWN_ACTION_SHAS: dict[str, dict[str, str]] = {
    ...
    "dorny/paths-filter": {
        "v4.0.3": "ceb8a2b8f2d89434be7ff52d3de7ec3738c5cc9d",  # phase-812-autofix (PR #491)
    ...
    "docker/login-action": {
        "v4.6.0": "dbcb813823bdd20940b903addbd779551569679f",  # phase-812-autofix (PR #491)
    ...
    "anchore/sbom-action": {
        "v0.24.2": "3ad7283483fc7af8ff2b4ea19663c2d5ca935e26",  # phase-812-autofix (PR #491)
    ...
    # phase-601 — SLSA container reusable workflow
