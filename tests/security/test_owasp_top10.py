...
class TestOWASPTop10:
    ...
    def test_a04_insecure_design(self):
        ...
        with pytest.raises((ValidationError, ProxyValidationError)):
            JA4Fingerprint(
                ja4="t13d1516h2_8daaf6152771_02713d6af862", timestamp=future_timestamp
            )
...
class TestAsyncSecurity:
    ...
    async def test_concurrent_validation(self):
        ...
        async def validate_fingerprint(i):
            try:
                return validator.validate_ja4_fingerprint(
                    f"t13d1516h{i % 10}_8daaf6152771_02713d6af862"
                )
