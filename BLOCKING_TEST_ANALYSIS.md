...
docker compose -f docker-compose.poc.yml exec redis redis-cli -a "GrAX4LL2WsdVbji9pCofWMwmrlZdSV" set "config:dial" 50
...
docker compose -f docker-compose.poc.yml exec redis redis-cli -a "GrAX4LL2WsdVbji9pCofWMwmrlZdSV" set "config:dial" 0
docker compose -f docker-compose.poc.yml restart proxy
```
