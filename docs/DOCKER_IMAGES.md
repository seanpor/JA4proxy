...
|-------|----------------|---------|---------------|-------|
| `python:3.14-slim` | `3.14.0-slim` | `deploy/docker/Dockerfile.admin`, `deploy/docker/Dockerfile.management`, `deploy/docker/Dockerfile.test`, `deploy/docker/Dockerfile.trafficgen` | 2026-06-13 | Base for all Python services |
| `python:3.14-alpine` | `3.14.0-alpine` | `src/analytics/Dockerfile`, `src/tarpit/Dockerfile`, `deploy/docker/update-checker/Dockerfile` | 2026-06-13 | Perl-free Python alpine base |
