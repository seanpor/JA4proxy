...
3.  **`docs/operations/SCALING_GUIDE.md`**: Update the scaling math. Python scaling is now documented as "Horizontal-only (Multi-node)," whereas Go is "Vertical-first (Multi-core)."
