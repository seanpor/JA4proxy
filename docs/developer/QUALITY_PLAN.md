...
- A test plan — see [`docs/developer/TESTING_STRATEGY.md`](TESTING_STRATEGY.md).
- A test-organization manual — see [`docs/developer/TESTING_STRATEGY.md`](TESTING_STRATEGY.md).
- An observability standard — see [`docs/reference/OBSERVABILITY_STANDARDS.md`](../reference/OBSERVABILITY_STANDARDS.md).
- A documentation style guide — see [`docs/developer/DOCUMENTATION_STANDARDS.md`](DOCUMENTATION_STANDARDS.md).
- A risk register — see [`docs/security/RISK_REGISTER.md`](../security/RISK_REGISTER.md).
...
[`docs/reference/SERVICE_TARGETS.md`](../reference/SERVICE_TARGETS.md) where applicable; if the two
...
[`docs/reference/SERVICE_TARGETS.md`](../reference/SERVICE_TARGETS.md) for the full justification.
...
| **Doc gate** | Pre-merge | `make lint-docs`, `make link-check`, `make doc-health`, `make lint-phases` | [`Makefile`](../../Makefile), [`docs/developer/DOCUMENTATION_STANDARDS.md`](DOCUMENTATION_STANDARDS.md) |
...
The methodology is in [`docs/developer/TESTING_STRATEGY.md`](TESTING_STRATEGY.md).
...
- [`docs/reference/SERVICE_TARGETS.md`](../reference/SERVICE_TARGETS.md) — SLIs, SLOs, SLA posture, error-budget policy
- [`docs/security/RISK_REGISTER.md`](../security/RISK_REGISTER.md) — consolidated risk register (Phase 106b)
- [`docs/reference/TRACEABILITY.md`](../reference/TRACEABILITY.md) — requirements-to-test matrix (Phase 106d, generated)
- [`docs/developer/TESTING_STRATEGY.md`](TESTING_STRATEGY.md) — full test methodology and phase-completion gate
- [`docs/developer/TESTING_STRATEGY.md`](TESTING_STRATEGY.md) — test layout, conftest, fixtures
- [`docs/developer/DOCUMENTATION_STANDARDS.md`](DOCUMENTATION_STANDARDS.md) — CHANGELOG / Redis schema / runbook / ADR formats
- [`docs/reference/OBSERVABILITY_STANDARDS.md`](../reference/OBSERVABILITY_STANDARDS.md) — Prometheus naming, JSON log schema, dashboards, alerts, SLIs
- [`docs/developer/STYLE_GUIDE.md`](STYLE_GUIDE.md) — config syntax, log format, doc language, REQ-tagging convention
