...
### Phase 333 — Bootstrap Finish — Go Wizard Migration & 231b Close-Out
*   **Status:** **PROPOSED** (Close-out of Phase 231b: update bootstrap.sh to use ja4p init (Go wizard, Phase 161) instead of the deprecated Python setup_wizard.py, archive superseded Python wizard, fix LaTeX install chapter to reflect Go-native wizard and remove stale TAP/Python references, mark Phase 231b COMPLETE. Deferred: real-host VM E2E validation (requires external infra).)
*   **Action Plan:** [PHASE_333.md](PHASE_333.md)
