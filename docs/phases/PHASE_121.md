...
| **121d** | Regression-test-per-finding rule | `docs/TESTING_STRATEGY.md` addendum + `make verify-findings` target | M | 121a, 121c |
...
**Deliverable:** `docs/TESTING_STRATEGY.md` addendum + `make verify-findings` extension.
...
- `docs/PROJECT_STATUS.md` regenerated via `make sync` and shows the wave structure at a glance.
...
| `docs/PROJECT_STATUS.md`, `docs/phases/TODO.md` | regenerated by `make sync` — do not hand-edit |
