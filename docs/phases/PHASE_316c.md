# PHASE 316c — Full JA4 Fingerprint Family (TAP)

> **STATUS: PROPOSED — OUTLINE. Depends on 316a + 316b.**
> Detailed plan to be fleshed out (to the depth of 316a/b) **before** this
> sub-phase starts — once 316a/b have landed and the capture/store seams are real.
...
- **Reusable from inline Go:** the GREASE filter + SHA-256 hashing helpers, and
  ...
  **ServerHello parser** the inline path never had (316a surfaces the bytes).
...
real-Redis integration + performance), and whether 316c itself should split
(e.g. 316c-1 TLS-side JA4S/JA4T, 316c-2 HTTP JA4H/JA4H2, 316c-3 JA4SSH/JA4L/QUIC).
