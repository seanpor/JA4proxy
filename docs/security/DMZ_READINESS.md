...
- [ ] Dial value is `0` at first start (monitor mode); see
      [Evaluation Checklist](../product/EVALUATION_CHECKLIST.md)
- [ ] Backup procedure tested against a non-production Redis
- [ ] [`docs/operations/INCIDENT_RESPONSE.md`](../operations/INCIDENT_RESPONSE.md) walked through
...
- [Scope and Limitations](../product/SCOPE_AND_LIMITATIONS.md) — what JA4proxy does NOT
  cover
- [`docs/security/DEPLOYMENT_SECURITY_MODEL.md`](DEPLOYMENT_SECURITY_MODEL.md) —
