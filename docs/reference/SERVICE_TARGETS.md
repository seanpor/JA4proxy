...
- [`docs/developer/QUALITY_PLAN.md`](../developer/QUALITY_PLAN.md) — quality plan (Phase 106h)
- [`docs/reference/OBSERVABILITY_STANDARDS.md`](OBSERVABILITY_STANDARDS.md) — metrics, log schema, SLI definitions (§6)
