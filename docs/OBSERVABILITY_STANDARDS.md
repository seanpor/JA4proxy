...
All rules live in `config/alertmanager/rules/ja4proxy.yml`.
...
5. New alert rules go in `config/alertmanager/rules/ja4proxy.yml` (§4) following the existing format.
