...
| Bloom filter (enrichment dedup) | [`src/cache/bloom.py`](../../archive/python_legacy/src/cache/bloom.py) | Phase 0 | [`tests/unit/test_bloom.py`](../../archive/python_legacy/tests/unit/test_bloom.py) | RedisBloom with SET-fallback. |
| Go proxy entry point (TCP accept loop, forward / tarpit / block) | [`cmd/proxy/main.go`](../../cmd/proxy/main.go) | Phase 15 | [`cmd/proxy/lifecycle_test.go`](../../cmd/proxy/lifecycle_test.go) | Production runtime (Phase 15 promotion). |
| Management API (FastAPI) | [`src/management/app.py`](../../src/management/app.py) | Phase 13 | [`tests/management/test_api.py`](../../tests/management/test_api.py) | Python-only; not on the proxy hot path. |
| TAP mode pipeline (passive SPAN/TAP capture) | [`src/tap/tap_pipeline.py`](../../archive/python_legacy/src/tap/tap_pipeline.py) | Phase 20 | [`tests/unit/tap/test_tap_pipeline.py`](../../archive/python_legacy/tests/unit/tap/test_tap_pipeline.py) | AF_PACKET capture; 5-level signal action scale. |
| TAP mode reassembler | [`src/tap/reassembler.py`](../../archive/python_legacy/src/tap/reassembler.py) | Phase 20 | [`tests/unit/tap/test_reassembler.py`](../../archive/python_legacy/tests/unit/tap/test_reassembler.py) | Out-of-order TCP reordering with stream eviction. |
| TAP fingerprint store | [`src/tap/fingerprint_store.py`](../../archive/python_legacy/src/tap/fingerprint_store.py) | Phase 20 | [`tests/unit/tap/test_fingerprint_store.py`](../../archive/python_legacy/tests/unit/tap/test_fingerprint_store.py) | 7 Redis key types; conn 7d / IP 30d retention. |
| TAP enforcement bridge | [`src/tap/enforcement_bridge.py`](../../archive/python_legacy/src/tap/enforcement_bridge.py) | Phase 20 | [`tests/unit/tap/test_enforcement_bridge.py`](../../archive/python_legacy/tests/unit/tap/test_enforcement_bridge.py) | Pub/sub fan-out: iptables / BGP / webhook (HMAC-SHA256). |
