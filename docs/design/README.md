...
| Tarpit / slow-loris responder | [`src/tarpit/tarpit-server.py`](../../src/tarpit/tarpit-server.py) | Phase 14 | [`cmd/ja4pd/pentest_tarpit_slot_exhaustion_regression_test.go`](../../cmd/ja4pd/pentest_tarpit_slot_exhaustion_regression_test.go) | Phase 14c added per-IP concurrent caps. |
