---
name: review-phase
description: Perform a comprehensive cybersecurity / DevOps / SRE / architect critical review of a phase document, then decompose it into small, junior-engineer-ready sub-tasks.
---
...
**Invocation:** `/review-phase <phase-number>` (e.g., `/review-phase 201`)
