...
func run(cfg runConfig, log *logrus.Logger) error {
	...
	return drive(ctx, lt, src, closeFn, store, enforcer, cfg.quiet, cfg.eventBuffer, cfg.excludeIPs, &eventCount, cfg.enableQUIC, log)
}
...
func drive(ctx context.Context, lt layers.LinkType, source tap.PacketSource, closeFn func() error, store *tap.Store, enforcer *tap.Enforcer, quiet bool, eventBuffer int, excludeIPs *atomic.Pointer[tap.ExcludeList], eventCount *atomic.Int64, extra ...any) error {
	...
	return wd.Run(ctx,
		...
		func() *tap.Sensor { return tap.NewSensor(lt, eventBuffer, enableQUIC) },
		func(s *tap.Sensor) {
