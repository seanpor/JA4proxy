...
class TestTrackConnection:
    ...
    async def test_track_connection_single_strategy(self, mock_redis, test_config):
        ...
        test_config["security"]["rate_limit_strategies"]["by_ip_ja4_pair"][
            "enabled"
        ] = False
    ...
    async def test_track_connection_redis_error_fails_closed(
        self, mock_redis, test_config
    ):
    ...
    async def test_track_connection_different_windows(self, mock_redis, test_config):
        ...
        results_short = await tracker.track_connection(
            "t13d1516h2_abc123_def456", "192.168.1.100", window="short"
        )

        # Medium window
        results_medium = await tracker.track_connection(
            "t13d1516h2_abc123_def456", "192.168.1.100", window="medium"
        )
...
class TestGDPRCompliance:
    ...
    async def test_ttl_set_on_tracking(self, mock_redis, test_config):
        ...
        await tracker.track_connection("t13d1516h2_abc123_def456", "192.168.1.100")
